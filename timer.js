...
const startDate = new Date(2017, 7, 24, 06, 00, 00).getTime();// initial date and time the countdown clock started from (Year, Month, Day, Hours, Minutes, Seconds,)
...
function liveStream (){
	window.location.assign("http://www.vkshop.in/yubob");
}
